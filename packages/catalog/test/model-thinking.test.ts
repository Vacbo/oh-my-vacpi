...
describe("Effort.Max clamping and mapping invariants", () => {
	...
	it("clamps XHigh down for sparse ladders that happen to expose Max", () => {
		...
		// Sparse custom ladder: XHigh is between Low and Max in canonical order, so it clamps down to Low.
