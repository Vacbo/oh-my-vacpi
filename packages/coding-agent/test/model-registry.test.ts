...
describe("ModelRegistry", () => {
	...
	describe("cached discovery on startup", () => {
		...
		test("loads cached special provider discovery models on startup", () => {
			// Antigravity retired the low-variant id into the collapsed bundled selector on startup.
			expect(specialCache.find("google-antigravity", "gemini-3.5-flash-low")?.maxTokens).toBe(65_536);
