...
import { searchSkillsRenderer } from "./search-skills";
...
export const toolRenderers: Record<string, ToolRenderer> = {
	...
	search_skills: searchSkillsRenderer as ToolRenderer,
	// `ssh` is a discoverable device mounted under `xd://`; the device dispatch
	// resolves its renderer through this map by tool name.
	...
	// Historical transcripts recorded this fork's todo tool as `todo_write`.
	// Replays of those sessions must still render through the todo renderer.
	todo_write: todoToolRenderer as ToolRenderer,
