...
import { formatDuration, Snowflake, sanitizeText, setProjectDir } from "@oh-my-pi/pi-utils";
...
import { buildContextManifest, toContextManifestSession } from "../../modes/utils/context-manifest";
...
export class CommandController {
	...
	#openContextInspector(): void {
		const manifest = buildContextManifest(toContextManifestSession(this.ctx.session));
