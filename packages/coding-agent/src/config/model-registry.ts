...
export class ModelRegistry {
	...
	/**
	 * Availability predicate memoized by provider: a provider is available when
	 * it is not disabled and is either keyless or has auth configured (stored
	 * credential or env key). Memoizing per provider is what keeps filtering the
	 * full bundled catalog cheap (thousands of models, ~50 providers).
	 */
	 ...
	 * with stored credentials, and providers whose key comes from the environment.
	 * See issue #993.
	 *
