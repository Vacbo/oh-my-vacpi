...
export class Settings {
	...
	async #loadProjectSettings(): Promise<RawSettings> {
		...
		// `#loadYaml` canonicalized any legacy Fire Pass selector in memory; persist
		// it for the native project config, whose file this instance owns. The
		// on-disk text check keeps the write to files that genuinely still hold the
