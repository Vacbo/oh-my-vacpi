...
export const SETTINGS_SCHEMA = {
	...
	"tools.essentialOverride": {
		...
		ui: {
			...
			description:
				"Override the always-loaded built-in tools (default: read, bash, edit, write, find, eval). Leave empty to use defaults. Pin/unpin per tool with ctrl+p in /tools.",
		},
	},
	...
	"thinkingBudgets.max": { type: "number", default: 64000 },
} as const;
