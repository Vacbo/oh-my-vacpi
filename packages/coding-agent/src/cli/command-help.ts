...
export const sessionsHelp = { description: "Inspect live OMP sessions" } satisfies CommandMetadata;
...
export const updateHelp = {
	description: "Start a session that merges the latest upstream tag into this fork",
} satisfies CommandMetadata;
